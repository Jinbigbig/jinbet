...
### 变更
- ✏️ `index.html` "保存赔率"按钮改名为"修改保存"，移至"清空"按钮前，样式从 `btn-success` 改为 `btn-outline` 与清空/归档按钮统一
- 🔔 保存提示文字更新为"修改已保存"

## [7.98.0] - 2026-08-06

### 新增
- ⚽ 赛果自动填充与归档功能（results_data.json、results_history/）

### 变更
- 🎨 赛果页面按钮布局优化，添加按钮位置固定
- 🧹 清空全部不再生成空白记录
- 📝 赛果加载改为追加模式，按日期排序分组显示

## [7.96.2] - 2026-08-01

### 新增
- 🤖 CI 工作流修复：先推送 master 再推送 gh-pages，保持双分支同步
- 🏆 联赛字段从赔率数据自动读取，国家队兜底为"国际赛"
