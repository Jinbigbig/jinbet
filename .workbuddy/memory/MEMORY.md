...
- 联赛 id：英超92/西甲85/德甲39/意甲34/法甲93/荷甲99/葡超88/瑞超103/芬超105/挪超104/巴甲160/日职102/日乙347/法乙171/意乙95/西乙96/德乙140。**美职(MLS)、亚冠精英、亚运女足 7M 无对应赛季 id**（勿编造）。
- 排名反填：`_build_today_extras.py` 除回收旧报告外，另从 `league_data.json` 用 `match_team_strict()`（只认精确+ALIAS，关闭子串回退）反填 home_rank/away_rank。
